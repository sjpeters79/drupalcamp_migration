...
#
# Dropfort machine: https://app.dropfort.com/machine/2805
# Dropfort environent: https://app.dropfort.com/environment/1389

VAGRANTFILE_API_VERSION = "2"
Vagrant.require_version ">= 1.8.0"
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  config.vm.host_name = '668f8515-2632-4741-8d64-f483825ea30d.dropfort.com'
...
-----END PRIVATE KEY-----
' > /var/lib/puppet/ssl/private_keys/668f8515-2632-4741-8d64-f483825ea30d.dropfort.com.pem
...
-----END PUBLIC KEY-----
' > /var/lib/puppet/ssl/public_keys/668f8515-2632-4741-8d64-f483825ea30d.dropfort.com.pem
"
  # Set puppet master
  config.vm.provision "puppet_server" do |puppet|
    puppet.puppet_server = "provisioner.dropfort.com"
    puppet.puppet_node = "668f8515-2632-4741-8d64-f483825ea30d.dropfort.com"
